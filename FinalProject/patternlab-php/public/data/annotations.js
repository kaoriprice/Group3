...
"comments" : [
	...
	},
	{
		"el": ".hero__image",
		"title" : "Hero image",
		"comment": "<p>The hero image should cover the entire width of the screen up to 1600px, and contains the hero message.</p>"
	},
	{
		"el": ".hero__message",
		"title" : "Hero message",
		"comment": "<p>The hero message should be *color*, *font size* in *font type*. It should be between *30 characters* to *50 characters*. .</p>"
	},
	{
		"el": ".hero__button",
	...
	{
		"el": ".content__tagline",
		"title" : "Tagline for title level 2",
		"comment": "<p>The header 2 is the second biggest header used on the main content of the page. It should be *color*, *font size* in *font type*.</p>"
	},
	{
	...
	},
	{
		"el": ".form__submit",
		"title" : "Form button",
		"comment": "<p>The form button should have *radius* border radius. IT should be *color*. The text should be *size*. </p>"
	},
	{
		"el": ".map",
		"title" : "Map",
